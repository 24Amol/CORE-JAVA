        ...
        <nav id="sidebar" class="shadow">
            ...
            <ul class="list-unstyled components">
                <li class="active shadow m-3 text-center" style="background: #9AC9DF; border-radius: 10px;">
                    <a href="../Pages/Home.php" target="iframe">Home</a>
                </li>
                <li class="shadow m-3 text-center" style="background: #9AC9DF; border-radius: 10px;">
                    <a href="../Pages/NewOrder.php" target="iframe">New Order</a>
                </li>
                <li class="shadow m-3 text-center" style="background: #9AC9DF; border-radius: 10px;">
                    <a href="../Pages/ViewOrder.php" target="iframe" >View Order</a>
                </li>
                <li class="shadow m-3 text-center" style="background: #9AC9DF; border-radius: 10px;">
                    <a href="../Pages/Profile.php" target="iframe">Profile</a>
                </li>
                <li class="shadow m-3 text-center" style="background: #9AC9DF; border-radius: 10px;">
                    <a href="../Pages/ContactUs.php" target="iframe">Complaint</a>
                </li>
            </ul>
        </nav>
        <div style="width: 100%; height: 100%;">
            <div class="container-fluid " style="height: 712px;">
                ...
                <div class="row " style="height: 600px;">
                    <iframe name="iframe" class="col-lg-12 col-md-12 col-sm-12" src="../Pages/Home.php" width="100%"
                        height="100%" scrolling="no"
                        style="border: none ;overflow: hidden; height: 100%; width: 100%; margin: 0px;">
                    </iframe>
                </div>
            </div>
        </div>
