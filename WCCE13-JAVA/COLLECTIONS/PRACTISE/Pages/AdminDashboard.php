        ...
        <nav id="sidebar" class="shadow">
            <div class="sidebar-header">
                <div class="text-center">
                    <a href="../Html/index.html"><img src="../images/whilte-logo.png" style="width: 150px" alt="logo" /></a>
                </div>
            </div>

            <ul class="list-unstyled components">
                <li class="active shadow m-3 text-center" style="background: #9AC9DF; border-radius: 10px;">
                    <a href="../Pages/AdminHome.php" target="iframe">Home</a>
                </li>
                <li class="shadow m-3 text-center" style="background: #9AC9DF; border-radius: 10px;">
                    <a href="../Pages/CustomberDetails.php" target="iframe">Customer Details</a>
                </li>
                <li class="shadow m-3 text-center" style="background: #9AC9DF; border-radius: 10px;">
                ...
                <li class="shadow m-3 text-center" style="background: #9AC9DF; border-radius: 10px;">
                    <a href="../Pages/UserDetails.php" target="iframe">Registration Details</a>
                </li>
                <li class="shadow m-3 text-center" style="background: #9AC9DF; border-radius: 10px;">
        ...
        <div style="width: 100%; height: 100%;">
            <div class="container-fluid " style="height: 712px;">
                    ...
                    <div class="row g-0 w-50 d-flex justify-content-center ">
                        ...
                        <div class="col-sm-6 col-md-6  d-flex justify-content-center">
                            <div class="dropdown">
                                ...
                                <a class="dropdown-item" href="../Html/index.php">Home</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row " style="height: 600px;">
                    <iframe name="iframe" class="col-lg-12 col-md-12 col-sm-12" src="../Pages/AdminHome.php" width="100%" height="100%" scrolling="no" style="border: none ; height: 100%; width: 100%; margin: 0px;">
                    </iframe>
                </div>
