                  ...
                  <div class="col-6 d-flex justify-content-center">
                    <div class="card text-white bg-primary mb-3 shadow" style="width: 15rem; height:10rem ;">
                        <div class="card-body">
                          ...
                          <p class="card-text fs-3"  style="font-family: 'Kalam', cursive; font-weight:bold;text-align: center;">Number Of Registered Users</p>
                        </div>
                      </div>
                  </div>
                  <div class="col-6 d-flex justify-content-center ">
                    <div class="card text-white bg-danger mb-3 shadow" style="width: 15rem;height:10rem ;">
                        <div class="card-body">
                            ...
                            <p class="card-text fs-3"  style="font-family: 'Kalam', cursive; font-weight:bold;text-align: center;">Number Of Enquires</p>
                          </div>
                      </div>
                  ...
                  <div class="col-6 d-flex justify-content-center ">
                    <div class="card text-white bg-info mb-3 shadow" style="width: 15rem;height:10rem ;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text fs-3"   style="font-family: 'Kalam', cursive; font-weight:bold;text-align: center;">Number Of Customers</p>
                          </div>
                      </div>
                  ...
                  <div class="col-6 d-flex justify-content-center ">
                    <div class="card text-white bg-warning y mb-3 shadow" style="width: 15rem;height:10rem ;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text fs-3 "  style="font-family: 'Kalam', cursive; font-weight:bold; text-align: center;">Number Of Complaints</p>
                          </div>
                      </div>
